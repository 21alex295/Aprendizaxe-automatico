...
patient_data = load_BD_2iter(load(db_name));
...
for neighbors = 1:50
    for i = 1:50
        ...
        binary_test_output_expected = [ismember(test_output_expected, 2) 
                                        ismember(test_output_expected,1) 
                                        ismember(test_output_expected,0)];
        binary_test_output          = [ismember(test_output, 2)
        ...
        binary_training_output_expected = [ismember(training_output_expected,2)
                                        ismember(training_output_expected,1) 
                                        ismember(training_output_expected,0)];
        binary_training_output          = [ismember(training_output, 2)
